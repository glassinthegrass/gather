...
const Group =(props)=>{
    ...
    let url = group.picture_public_id?`https://res.cloudinary.com/glassinthegrass/image/upload/w_50,h_50,g_auto,c_fill_pad,r_5,f_png/` +
        ...
        const toggleDisplay= toggle? <OptionBox onClick={()=>handleDeleteClick()}>remove group</OptionBox>:<></>;
    return<MapContainer>
